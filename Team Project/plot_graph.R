...
sma.50 <- SMA(df$end_price, 50)
sma.100 <- SMA(df$end_price, 100)
sma.200 <- SMA(df$end_price, 200)


df <- cbind(df, ema.50, ema.100, ema.200, sma.50, sma.100, sma.200)
...
ggplot(data=df, aes(x=dates)) +
  ...
  geom_line(aes(y=ema.50, color="sma.50")) +
  geom_line(aes(y=ema.100, color="sma.100")) +
  geom_line(aes(y=sma.200, color="sma.200")) +

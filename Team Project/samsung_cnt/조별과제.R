...
searchElem$sendKeysToElement(list("대우건설", key="enter"))
...
DW_news <- data.frame(dates, titles)
...
for (pgNum in 1:232) {
  ...
  stock_url <- str_c("https://finance.naver.com/item/sise_day.nhn?code=047040&page=", pgNum)
